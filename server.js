...
app.put('/student/updateappointment', async function(req, res) {
    try {
        ...
        // Extract the _id, status, and counsellor reply from the request body
        const { _id, status, counsellorReply } = req.body;
        ...
        // Update the appointment in the database using _id
